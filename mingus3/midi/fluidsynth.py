...
from mingus3.midi.sequencer import Sequencer
from . import pyfluidsynth as fluidsynth
...
class FluidSynthSequencer(Sequencer):
    ...
    def start_audio_output(self, driver='dsound'):
    ...
    def sleep(self, seconds):
        if hasattr(self, 'wav'):
            samples = fluidsynth.raw_audio_string(self.fs.get_samples(
                int(seconds * 44100)))
...
def init(sf2, driver='dsound', file=None):
