...
setup(
    ...
    author="Yunjie Wang, Bart Spaans",
    author_email="yunjiewang1@gmail.com, bart.spaans@gmail.com",
    url="https://github.com/yunjiewang/python-mingus",
    packages=['mingus3', 'mingus3.core', 'mingus3.containers', 'mingus3.extra', 'mingus3.midi'],
